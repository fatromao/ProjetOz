...
EXT2_SRC=src/ExtensionDenylist.oz
...
$(MAIN_OZF): $(MAIN_SRC) $(BASE_OZF) $(HELPER_OZF) $(EXT1_OZF) $(EXT2_OZF)
	$(OZ) -c $(MAIN_SRC) -o $(MAIN_OZF)

# Commande pour nettoyer les fichiers compilés
clean:
	rm -f $(BASE_OZF) $(HELPER_OZF) $(MAIN_OZF) $(EXT1_OZF) $(EXT2_OZF)
