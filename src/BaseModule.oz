...
define
    ...
    fun{TransitionHash Nonde Sender Receiver Value}
    TransitionHash = (nonce + sender + receiver + value) mod 1000000
    end

    fun{BlockHash Number previsousHash hashTransactioni}
